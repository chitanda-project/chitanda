...
const file_integration_xray_config_proto_rawDesc = "" +
	"\n" +
	"\x1dintegration/xray/config.proto\x12\x13xray.proxy.chitanda\"\x84\x02\n" +
	...
	"\bkey_file\x18\t \x01(\tR\akeyFile\"\xee\x01\n" +
...
var file_integration_xray_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
